    ...
    <>
      ...
      <nav className="nav">
        <div className="nav__inner">
          ...
          <a href="https://wa.me/355000000000" className="nav__cta">Contattaci →</a>
        </div>
      </nav>
      ...
      <section style={{ background: "radial-gradient(ellipse 80% 50% at 50% -10%, rgba(232,168,56,.12), transparent)" }}>
        <div className="hero">
          ...
          <div className="hero__actions">
            <a href="https://wa.me/355000000000" className="btn-primary">Inizia ora →</a>
      ...
      <div className="tenants">
        ...
        <div className="tenants__visual">
          <p style={{ fontSize: ".72rem", color: "#6B6760", textTransform: "uppercase", letterSpacing: ".08em", marginBottom: 4 }}>Locali attivi</p>
          {[
            ["La Piazzetta", "lapiazzetta"],
            ["Pizzeria Roma", "pizzeriaroma"],
            ["Da Mario", "damario"],
            ["Il Forno", "ilforno"],
          ].map(([name, slug]) => (
      ...
      <div className="pricing">
        <div className="pricing__inner">
          ...
          <div className="price-card">
            ...
            <a href="https://wa.me/355000000000" className="btn-primary" style={{ display: "block", textAlign: "center" }}>
              Inizia ora →
            </a>
      ...
      <section className="cta-section">
        ...
        <div className="cta-section__contact">
          <a href="https://wa.me/355000000000" className="cta-link cta-link--wa">
